...
class DiaryForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["content"].widget.attrs[
            "placeholder"
        ] = "Today is a new day, full of possibilities and experiences. Write down your thoughts, dreams, and experiences below to immortalize the moments that made today special."
