...
Tag = NamedTuple(
    "Tag", [("tag", str), ("username", str), ("extra_property", str), ("url", str)]
)
...
class ProfilePictureComponent(Component):
    ...
    def link(self, html: str) -> str:
        ...
        if not self.tags:
            return html
        url_pictures = self.pull_url_profile_picture()
...
#
#
# class PictureComponent(BasicComponent):
#     def __init__(self):
#         self._pattern = re.compile(r"<img src=@img-([a-zA-Z0-9@/./+/-/_]+) (.*)>")
#         self._template = (
#             '<img src="{url_img}" {extra_property} >'
#         )
#         self.endpoint = partial(reverse, "photo:picture-detail")
#
#         self.tags = []
#
#     def find(self, html: str) -> None:
